...
<div class="logoBar">
  <div class="comWidth">
    <div class="logo fl"> <a href=""><img src="images/logo.gif" alt="码农商城"/></a> </div>
        ...
        <div class="Products_list">
            <#list products as product>
               <div class="Products_item">
                    <div class="item_img"><a href="#"><img src="http://65.49.227.129:8888/${product.imgUrl}" alt="" width="200px"/></a></div>
                    <div class="item_cont">
